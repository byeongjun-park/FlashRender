...
class VGGT(nn.Module, PyTorchModelHubMixin):
    ...
    def shortcut_forward(self, images: torch.Tensor, num_layers=1):
        """
        ...
        patch_start_idx, shallow_features = self.aggregator.shortcut_forward(images, num_layers)
        return patch_start_idx, shallow_features
